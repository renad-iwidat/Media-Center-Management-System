  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="glass-panel p-8 space-y-6">
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-[#2563eb]/20 outline-none transition-all placeholder:text-gray-600 resize-none leading-relaxed"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full bg-white/10 border border-white/10 rounded-xl py-2.5 px-4 outline-none focus:ring-2 focus:ring-[#2563eb]/20"
              >
                {activeMode === 'REWRITE' && (
                  <>
        ...
        <div className="glass-panel p-8 bg-[#0b1224] border-dashed border-white/10 flex flex-col">
