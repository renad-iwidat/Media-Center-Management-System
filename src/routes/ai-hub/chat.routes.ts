 ...
 * }
 */
router.post('/generate', createAILogger('chat', 'generate'), generateChatResponse);

/**
 * POST /api/ai-hub/chat/summarize - تلخيص نص
 * Request body: { "text": "string", "style": "bullet_points|short_paragraph|headlines" }
 */
router.post('/summarize', createAILogger('text_tools', 'summarize'), summarizeText);
 ...
 */
router.post('/rewrite', createAILogger('text_tools', 'rewrite'), rewriteText);
