...
// ID-based routes - Specific routes first
router.get('/:id/statuses', requirePermission('tasks.view'), (req: Request, res: Response) => { taskController.getTaskStatuses(req, res); });
