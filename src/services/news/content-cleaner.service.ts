...
- احذف اسم أي وكالة أنباء أو وسيلة إعلام من بداية ونهاية الخبر (مثل: وفا، سوا، معاً، الجزيرة، العربي الجديد، رويترز، فرانس برس، القدس العربي)
- لا تبدأ الخبر بعبارات مثل: "أفادت وكالة..." أو "ذكرت صحيفة..." — ابدأ مباشرة بالحدث
- لا تحذف الإسناد الصحفي للأخبار الحصرية (مثل: قال فلان في مقابلة مع صحيفة كذا) — هذا يبقى داخل المتن
- حافظ على: المحتوى الصحفي بالكامل، الاقتباسات، الأسماء، الأرقام، تسلسل الفقرات
- لا تعيد صياغة الخبر، فقط نظّفه

الناتج يجب أن يكون خبرًا نظيفًا بدون أي عناصر ترويجية أو روابط أو توجيه للقارئ أو اسم مصدر السحب.
